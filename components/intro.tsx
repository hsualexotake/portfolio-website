...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="flex flex-col sm:flex-row items-center justify-center gap-2 -4 text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.5, type: "spring", duration: 8.5 }}
      >
        <Link
          href="#contact"
        ...
        <a
          ...
          href="https://www.linkedin.com/in/alex-hsu-bba77b223/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/hsualexotake"
          target="_blank"
        >
          <FaGithub />
        </a>
